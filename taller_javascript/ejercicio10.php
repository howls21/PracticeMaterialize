...
<html>
    ...
    <body class="lime darken-4">

        <div class="row">
            <div class="container">
                <h1 class="center-align white-text">EJERCICIO 10</h1>
            ...
            <script type="text/javascript">
                $(function () {
                    ...
                    function cargarNoticias() {
                        ...
                        $.each(paises, function (i, o) {
                            var fila = "";
                            fila += "<li><div class='collapsible-header lime darken-2 white-text'><i class='material-icons'>filter_drama</i>" + o.nomeFormal + "</div>";
                            fila += "<div class='collapsible-body lime lighten-4'><span>" + "Codigo: " + o.codigo + "<br> Fono: " + o.fone + " <br>ISO: " + o.iso + "</span></div></li>";
